/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env local --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: de20fee14993ce6729da5a1b97965ed8)
// Runtime types generated with workerd@1.20250829.0 2025-04-02 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV_QUICKBOOKS: KVNamespace;
		NEXT_PUBLIC_URL: "https://allthingslinux.dev" | "https://allthingslinux.org" | "http://localhost:8788";
		NEXT_PUBLIC_API_URL: "https://allthingslinux.dev/api" | "https://allthingslinux.org/api" | "http://localhost:8788/api";
		...
		WORKER_SELF_REFERENCE: Fetcher /* local */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_URL" | "NEXT_PUBLIC_API_URL" | "NEXT_PUBLIC_GITHUB_REPO_OWNER" | "NEXT_PUBLIC_GITHUB_REPO_NAME" | "NODE_ENV" | "GITHUB_TOKEN" | "MONDAY_API_KEY" | "MONDAY_BOARD_ID" | "TRIGGER_SECRET_KEY" | "DISCORD_WEBHOOK_URL" | "QUICKBOOKS_ENVIRONMENT" | "QUICKBOOKS_CLIENT_ID" | "QUICKBOOKS_CLIENT_SECRET" | "QUICKBOOKS_REFRESH_TOKEN" | "QUICKBOOKS_REALM_ID" | "QUICKBOOKS_ADMIN_KEY">> {}
}
