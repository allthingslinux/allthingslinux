...
export const systemsRoles: Role[] = [
  ...
  },
  {
    ...
    department: 'Systems',
    description:
      'Python Developers are responsible for developing and maintaining Python related projects like our Discord bot, Tux. Experience with discord.py, httpx, poetry, and strict typing is desired.',
    questions: [...systemsQuestions],
  },
];
