...
const statsData = [
  { id: 1, value: '6.5M+', description: 'messages' },
  { id: 2, value: '10K+', description: 'members' },
  { id: 3, value: '45K+', description: 'voice hours' },
  { id: 4, value: '30+', description: 'staff members' },
  { id: 5, value: '700+', description: 'support threads' },
